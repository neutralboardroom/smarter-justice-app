# Smarter Justice v1.7.75 Change Map

## Material implementation

- Added `PROVIDER_DISCOVERY_OWNER_AUTHORIZATION_SCHEMA_V1.7.75.json`.
- Added `PROVIDER_DISCOVERY_OWNER_AUTHORIZATION_PACKET_V1.7.75.json`.
...
- `smarter-justice-v1.7.73.zip` as exact source and immediate rollback.
- Launch state `NO_GO`.
