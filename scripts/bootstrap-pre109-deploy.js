...
for(const rel of ['server.js','lib/formEnginePre109.js','scripts/pre109_fill_official_pdf.py','public/forms-center.html','public/legal-areas/immigration.html','public/legal-areas/taxes.html','vendor/pre109/immigration-oasis/data/official-pdf-cache/g-1145.pdf','vendor/pre109/justice-tax-solutions/assets/official-forms/irs-individual-income-tax/f1040 U.S. Individual Income Tax Return.pdf','vendor/pre109/justice-tax-solutions/assets/official-forms/irs-tax-debt-resolution/f9465 Installment Agreement Request.pdf','.python-vendor/pypdf/__init__.py'])assert(fs.existsSync(path.join(target,rel)),`missing PRE109 deploy-critical file: ${rel}`);
