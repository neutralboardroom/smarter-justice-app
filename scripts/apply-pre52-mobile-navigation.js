...
for(const name of fs.readdirSync(pub).filter(n=>n.endsWith('.html'))){
  ...
  s=s.replace(/focused legal portal/gi,'Smarter Justice legal area');
  s=s.replace(/focused micro-portals/gi,'Smarter Justice legal areas');
  s=s.replace(/focused micro-portal/gi,'Smarter Justice legal area');
  s=s.replace(/focused portals/gi,'Smarter Justice legal areas');
  s=s.replace(/focused portal/gi,'Smarter Justice legal area');
  s=s.replace(/portal-presence preparation/gi,'legal-area presence preparation');
  s=s.replace(/participating portal presences/gi,'participating legal-area presences');
  s=s.replace(/relevant focused portals/gi,'relevant Smarter Justice legal areas');
  s=s.replace(/Browse Smarter Justice legal areas/gi,'Browse legal areas');
  s=s.replace(/Browse focused portals/gi,'Browse legal areas');
  s=s.replace(/Four Smarter Justice legal areas, one central profile system\./gi,'Popular Smarter Justice legal areas, one connected professional profile system.');
  s=s.replace(/Full specialty attorney and firm pages belong on each portal\. Smarter Justice handles central accounts, claims, shared profile management, firm relationships, and approved read-only distribution\./gi,'Professional profiles can connect to the Smarter Justice legal areas that accurately fit the professional’s work, with central account, claim, firm, and profile controls.');
  s=s.replace(/Divorce Law Aid/g,'Divorce & Family Law');
