...
for(const marker of ["release:'v2.0.0-pre53'","demoPathRelease:'v2.0.0-pre52'","deploymentControlRelease:'v2.0.0-pre53'","SMARTER_JUSTICE_PRE53_RENDER_STARTUP_AND_LIVE_GATE","process.env.PORT","server.listen(port"]){
...
const result={ok:failures.length===0,release:'v2.0.0-pre53',runtimeVersion,port,render:Boolean(process.env.RENDER),fullQualificationLocation:'BUILD_AND_CI_NOT_RUNTIME_START',failures};
