# Initial Attorney Pilot Launch Runbook — v1.7.43
...
## Complimentary Founding Profile Pilot lane

Treat this as a separate lane from attorney applications and paid membership. Keep it closed until owner approval, production persistence, email delivery, owner/staff MFA, support, monitoring, privacy/terms, accessibility, rollback, cohort limits, and the stored pilot control are accepted. Opening requires the exact owner confirmation and evidence. It must never create paid, verified, specialty-approved, published, ranked, available, or endorsed status.
