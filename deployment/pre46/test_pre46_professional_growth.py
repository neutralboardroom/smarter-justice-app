...
pub=root/'public'
required=['professional-growth.html','professional-growth.js','marketing-compliance-pre46-data.js','professional-membership.html','attorney-partner-tour.html','practice-areas.html','navigator.html']
...
data=(pub/'marketing-compliance-pre46-data.js').read_text()
membership=(pub/'professional-membership.html').read_text()
tour=(pub/'attorney-partner-tour.html').read_text()
assert 'SMARTER_JUSTICE_PRE46_PROFESSIONAL_GROWTH' in page
...
assert 'SMARTER_JUSTICE_PRE46_PROFESSIONAL_GROWTH_CTA' in membership
assert '/professional-growth.html' in membership
assert 'SMARTER_JUSTICE_PRE46_GROWTH_LINK' in tour
...
print('PASS PRE46 professional growth workspace and marketing preflight')
