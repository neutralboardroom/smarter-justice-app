...
function inferPractice(question, selected){
  ...
  const rules = [
    ...
    ['bankruptcy-debt',['bankruptcy','chapter 7','chapter 13','debt collector','credit card lawsuit','garnishment']],
    ...
    ['trademarks',['trademark','brand name','logo infringement']],
    ['patents',['patent','invention','provisional']],
    ['copyrights',['copyright','dmca','takedown']],
    ['public-benefits',['snap','food stamps','medicaid','cash assistance','section 8']],
    ['employment-wage-claims',['unpaid wages','paycheck','unemployment','discrimination','retaliation','fired']],
    ['workers-compensation',['workers comp','work injury','comp board']],
    ['disability-benefits',['ssdi','ssi','disability benefits','social security denial']],
...
function buildStartingPoint({question, practiceArea, subcategory, state, county, city, attachments=[], documentType='', smartAnswers={}}){
  ...
  return {
    ...
    formReadiness,
    verifiedFormPaths,
    missingInformation: topPath?.missingFields || [],
    formPathEvaluation,
    smartAnswers,
